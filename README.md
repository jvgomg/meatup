...
- `attendees` - List of attendee first names (add surname initial where needed to disambiguate).

Attendee “first meat up” labels are derived automatically based on the earliest event containing each name.
